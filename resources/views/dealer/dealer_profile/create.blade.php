...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('admin.dealer-profile.store') }}" onSubmit="return confirm('Please verify before submit.')" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group {{ $errors->has('target') ? 'has-error' : '' }}">
                ...
                <input type="number" id="target" name="target" class="form-control" value="" required>
            ...
            <div class="form-group {{ $errors->has('registered_address') ? 'has-error' : '' }}">
                ...
                <input type="text" id="registered_address" name="registered_address" class="form-control" value="" required>
            ...
            <div class="form-group {{ $errors->has('store_name') ? 'has-error' : '' }}">
                ...
                <input type="text" id="store_name" name="store_name" class="form-control" value="" required>
            ...
            <div class="form-group {{ $errors->has('pincode') ? 'has-error' : '' }}">
                ...
                <input type="text" id="pincode" name="pincode" class="form-control" value="" required>
            ...
            <div class="form-group {{ $errors->has('dealer_category') ? 'has-error' : '' }}">
                ...
                <select name="dealer_category" id="dealer_category" class="form-control select2" required>
                    ...
                    @foreach($dealerCategory as $dealer)
            ...
            <div class="form-group {{ $errors->has('registration_date') ? 'has-error' : '' }}">
                ...
                <input type="text" id="registration_date" name="registration_date" class="form-control" value="" placeholder="2022-08-26" required>
